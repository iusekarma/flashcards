export default function Card(){
    return (
        ...
        <div className=" w-full group break-words bg-white  shadow-2xl  md:max-w-sm rounded-xl">
            <div className="pb-6">
                ...
                <div className="mt-2 mt-20 text-center">
                    <h3 className="mb-1 text-2xl font-bold leading-normal text-black">Ariel Cerda</h3>
                ...
                <div className="pt-6 mx-6 text-center ">
                    <div className="flex flex-wrap justify-center">
